...
#==============================================================================================================
admin = "c7d9b83eba191753b9b1add49a48fa3bf"
owner = "c7d9b83eba191753b9b1add49a48fa3bf"
Bots=[mid,"c7d9b83eba191753b9b1add49a48fa3bf"]
#==============================================================================================================
#==============================================================================================================
...
msg_dict = {}
bl = ["c7d9b83eba191753b9b1add49a48fa3bf"]
...
╠═════════════════════
╠🇹🇭✭ᎢᎪᎷᎬᏴᎾᎢᎪᎱᎷ✭🇹🇭
╠http://line.me/ti/p/~jakkapan6152
╠═════════════════════ 
"""
helpmusic ="""╠═════════════════════
╠✍คำสั่งเปิดปิดทั้งหมด:
...
#==============================================================================================================
                ...
                elif text.lower() == "คำสั่ง3" or text.lower() == ".":
                    helptr = helptrans
                ...
                elif text.lower() == "คำสั่ง2" or text.lower() == ".":
                    helpmc = helpmusic
...
#==============================================================================================================
                        if cmd == "tts":
                        ...
                        elif cmd == "รีบอท" or cmd == "reboot":
                            client.sendMessage(to, "Succes logout from bots")
                            settings["restartPoint"] = to
                            restartBot()
                        elif cmd == "me" or cmd == "คท":
                            client.sendMentionFooter(to, '「ผู้ใช้งาน」\n', sender, "https://line.me/ti/p/~phusamurai", "http://dl.profile.line-cdn.net/"+client.getContact(sender).pictureStatus, client.getContact(sender).displayName);client.sendMessage(to, client.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+client.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~phusamurai', 'type': 'mt', 'subText': "phuselfbot", 'a-installUrl': 'https://line.me/ti/p/~phusamurai', 'a-installUrl': ' https://line.me/ti/p/~phusamurai', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~phusamurai', 'i-linkUri': 'https://line.me/ti/p/~phusamurai', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~phusamurai'}, contentType=19)
                        elif cmd == "โย่ว":
                            userid = "https://line.me/ti/p/~" + client.profile.userid
                            ...
                            start = time.time()
                            client.sendMessage(to, "ความเร็วอยู่ที่...")
...
#==============================================================================================================
                            ...
                            client.sendMessage(to, str(ret_),contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+client.getContact(clientMID).pictureStatus, 'AGENT_NAME': 'MY STICKERS', 'AGENT_LINK': 'http://line.me/ti/p/~gg880.'})
...
#=========================================================================================
             ...
             #                     sendMention(to,"[ Send File ]\nType: Send Files\nI Am Send Your Files @!Please Wait",[sender])
                            ...
                            try:
                                ...
                                khietag = "ude3230559bf63a55b9c28aa20ea194e3"                        
            ...
            if msg.toType == 0:
                ...
                if msg.contentType == 0:
                    if msg.toType == 0:
                        ...
                        if settings["autoRead"] == True:
                            client.sendChatChecked(to, msg_id)
                if msg.text in ["ทีมงาน"]:
                    client.sendMessage(to, "✍Ŧ€₳M җ MIĐ₦IĞĦŦ✍")
                    client.sendContact(to, "ude3230559bf63a55b9c28aa20ea194e3")
                    client.sendContact(to, "u39c29f7f9865175f4378f6a5df715e11")
                    client.sendContact(to, "u7b0bb1665800a5aacf00e83b64c4e6fb")
                    client.sendContact(to, "ua9ff83cd324d68d68952753f556c07c2")
                    client.sendContact(to, "u80c7ac1e1381b1655fc779329a3dc48a")
                    client.sendContact(to, "u606505695d9308f88591b9bccd715c91")
                    client.sendContact(to, "ucc9d41de7468ccc03b1014edbdce9260")
                    client.sendMessage(msg.to,"😎😎ทีมงานคุณภาพ😎😎\n✍Ŧ€₳M җ MIĐ₦IĞĦŦ✍")                
                if msg.text in ["me","คท",".คท",".me","/me","!me"]:
                    client.sendMessage(msg.to,"✍เชคทั้งวันเลยนะ\nŦ€₳M җ MIĐ₦IĞĦŦ✍")
                if msg.text in ["สปีด",".สปีด","sp",".speed","speed","/speed"]:
                    client.sendMessage(msg.to,"✍แรงครับแรงแล้ว\nŦ€₳M җ MIĐ₦IĞĦŦ✍")
#==============================================================================================================
#=====================================================[]=======================================================
#==============================================================================================================
        if op.type == 32:
...
def cium(to, nama):
    ...
    akh = int(0)
    nm = nama
    myid = "ude3230559bf63a55b9c28aa20ea194e3"
    if myid in nm:    
      nm.remove(myid)
    #print nm
    for mm in nm:
