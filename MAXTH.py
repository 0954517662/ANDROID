...
╔▬▬▬▬▬▬▬▬▬▬▬▬▬▬╗
╠unbanall「kosong」
╠ล้างดำ/unban「pilih pesan」
╠บาย 「Ruang kosong」
╠on 「runtime」
╠invite:on「by contact」
╠แอด/ขาว「@」
╠resetfriend/เลิกเป็นเพื่อน
╠clearinvie/ลบรัน「group」
╠บล็อค/เลิกเป็นเพื่อน「@」/blokir 
╠blocklist/listblock
╠ดำ「by contact」
╠ขาส「by contact」
╠เชคคทดำ/banlist
...
╠ปกกู/cover「@」
╠myinfo/info「@」
╠ผู้สร้างกลุ่ม/infogroup/groupinfo
╠รูปกลุ่ม/groupku/mygroup
╠friendlist/mem
╚▬▬▬▬▬▬▬▬▬▬▬▬▬▬╝"""
...
╠อัพชื่อ/อัพตัส 「text」
╠อัพรูป/อัพวิดีโอ
╠ชื่อกลุ่ม「nama group」
╠เปลี่ยนรูปกลุ่ม「foto grup」
╠เลียนแบบ/เลิกเลียนแบบ「@」
╠ดูเลียนแบบ
╠เลียนแบบ on/off
╚▬▬▬▬▬▬▬▬▬▬▬▬▬▬╝"""
...
╠detailuser on/off
╠เปิด/ปิด มุดลิ้ง
╠เปิด/ปิด เข้ากลุ่มออโต้
╠เปิด/ปิด ออโต้บล็อค
╠เปิด/ปิด ออโต้แอด
╠เปิด/ปิด ออก
╠เปิด/ปิด อ่าน
╠เปิด/ปิด แทค
╠privatemention เปิด/ปิด
╠เปิด/ปิด คนเข้า
╠เปิด/ปิด คนออก
╠เตะแทค เปิด/ปิด
╠เชค「สติกเกอร์」 เปิด/ปิด
...
╠เปิดอ่านติ๊ก
╠ปิดอ่านติ๊ก
╠ตั้งอ่าน:「respmessage reader」
╠เปิดติ๊กคนแทค
╠ปิดติ๊กคนแทค
╠ตั้งแทค/group:「respmessage」
╠setpm:「text」
╠addautosticker
╠delautosticker
╠ตั้งคนแอด:「responmessage add」
╠เปิดติ๊กคนออก
╠ปิดติ๊กคนออก
╠ตั้งออก:「responmem leave」
╠เปิดติ๊กคนเข้า
╠ปิดติ๊กคนเข้า
╠ตั้งคนเข้า:「responmem join」
╚▬▬▬▬▬▬▬▬▬▬▬▬▬▬╝"""
        ...
        if op.type == 15:
            ...
            if settings["leaveMessage"] == True:
                ...
                if msgSticker != None:
                    ...
                    sver = msgSticker["STKVER"]
                    sendSticker(op.param1, sver, spkg, sid)
                sendMention(op.param1, op.param2, "telah meninggal kan kita", "{}".format(str(settings['leavePesan'])))
...
#==============================================================================================================
                        ...
                        elif cmd == "อัพวิดีโอ" and sender == clientMID:
...
#==============================================================================================================
                            ...
                            a = cmd.replace("broadcast", "")
                            cond = a.split("|")
                            if len(cond) == 1:
                                link = "https://line.me/ti/p/~max_pv"
                            else:
                                link = cond[1]
                            group = client.groups
                            b = ChatRoomAnnouncementContents()
...
#==============================================================================================================
                        ...
                        elif cmd.startswith("ส่งของขวัญ "):
                            sep = text.split(" ")
                            text = text.replace(sep[0] + " ","")
                            cond = text.split(" ")
                            jml = int(cond[0])
...
#==============================================================================================================
                        ...
                        elif cmd.startswith("allbcast "):
                            try:
                                message = cmd.replace("allbcast ","")
                                friends = client.friends
                                groups = client.groups
...
#==============================================================================================================
                        elif cmd == "ปฏิทิน" or cmd == "kalender":
                            ...
                            if msg.toType == 2:
                                ...
                                client.updateGroup(group)
                        elif cmd == ".me" or cmd == "คท":
                            try:
                    	        sendMention(to, sender, "「【さัএπัஞ✵ບิथℓℓҨतΩ】」\n•", "")
...
#==============================================================================================================
                        elif cmd == "mysticker" or cmd == "สติกเกอร์":
                            a = int("1")
                            b = int("1000")
                            c = str("EN")
                        ...
                        elif cmd == "ลบแชท" or cmd == "clearannoun":
                            ...
                            client.sendMessage(receiver, "readers detect on ready")
                            ...
                            if msg.to in sider['point']:
                                ...
                                client.sendMessage(receiver, "ketik「cyduk on」terlebih dahulu")
#==============================================================================================================
                        elif cmd == "เชคค่า":
                            md = "╔▬▬▬▬ ꜱᴇᴛᴛɪɴɢꜱ ▬▬▬▬╗\n"
...
#====================
#====================
                        elif cmd == "เปิดเชคคท" or cmd == "checkcontact on":
                            settings["checkContact"] = True
                            client.sendMessage(to, "check detail user by contact diaktifkan")
                        elif cmd == "ปิดเชคคท" or cmd == "checkcontact off":
...
#====================
                            ...
                            settings["notag"] = True
                            client.sendMessage(to, "mode tag-kick telah diaktifkan")
                        elif cmd == "ปิดเตะแทค":
                            settings["notag"] = False
                            client.sendMessage(to, "mode tag-kick telah dinonaktifkan")
                        elif cmd == "เปิดคนออก":
                        ...
                        elif cmd == "stickerkick on" or cmd == "/nosticker:0":
                                settings["sticker"] = True
                                client.sendMessage(to,"auto kick sticker chat diaktifkan")
                        elif cmd == "stickerkick off" or cmd == "/nosticker:1":
                                settings["sticker"] = False
                                client.sendMessage(to,"auto kick sticker chat dinonaktifkan")
                        elif cmd == "sleepmode":
...
#==============================================================================================================
                            ...
                            mic = msg.text.lower().replace("เลียนแบบ ","")
                            if mic == "on":
...
#==============================================================================================================
                        ...
                        elif cmd == "conban" or cmd == "คทติดดำ":
                            if msg._from in clientMID:
                                if settings["blacklist"] == []:
                        ...
                        elif cmd.startswith("เลิกเป็นเพื่อน "):
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                names = re.findall(r'@(\w+)', text)
                                mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                                mentionees = mention['MENTIONEES']
...
#==============================================================================================================
                        elif cmd == "mention" or cmd == "tagall" or cmd == "แทค" or cmd == "แท็ก":
                            group = client.getGroup(msg.to)
...
#=========================================================================================
                        ...
                        elif cmd == "ผส" or cmd == "creator":
                            sendMention(to, sender, "「 Auto Mentions 」\n•", "\nThis is my Creator..")
                            client.sendContact(to, "u4862fe4b182b2fd194a3108e2f3662e8")
                        elif cmd == "ชื่อ" or cmd == "name":
                            h = client.getContact(clientMID)
                            sendMention(to, sender, "「 Auto Mention 」\n•", "\nDisplay Name : \n" + str(h.displayName))
                        elif cmd == "ตัส" or cmd == "stats":
                            h = client.getContact(clientMID)
                            sendMention(to, sender, "「 Auto Mention 」\n•", "\nStatus Message : \n" + str(h.statusMessage))
                        elif cmd == "รูป" or cmd == "picture":
                            h = client.getContact(clientMID)
                            sendMention(to, sender, "「 Auto Mention 」\n•", "\nThis is my picture...")
                            client.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/" + h.pictureStatus)
                        elif cmd == "ปก" or cmd == "cover":
                            cu = client.getProfileCoverURL(clientMID)          
                            path = str(cu)
                            sendMention(to, sender, "「 Auto Mention 」\n•", "\nThis is my cover...")
                            client.sendImageWithURL(msg.to, path)
                        elif cmd == "วิดีโอ" or cmd == "video":
                            h = client.getContact(clientMID)
                            sendMention(to, sender, "「 Auto Mention 」\n•", "\nThis is my video...")
             ...
             #                     sendMention(to,"[ Send File ]\nType: Send Files\nI Am Send Your Files @!Please Wait",[sender])
                            ...
                            number = cmd.replace("ข้อมูลกลุ่ม ","")
                            groups = client.getGroupIdsJoined()
                            ret_ = ""
                            try:
                            ...
                            try:
                                ...
                                client.sendMessage(to, "「 Result Error 」\n" + str(error))
                        elif cmd == "กลุ่มกู" or cmd == "mygroup":
                            groups = client.getGroupIdsJoined()
                            ret_ = "「 Semua grup 」"
                            no = 1
                            for gid in groups:
   ...
   #                             client.sendMessage(to, str(ret_))
                                clientMention(to, str(ret_),[phietag])
                            except Exception as error:
                                client.sendMessage(to, "「 Result Error 」\n" + str(error))
